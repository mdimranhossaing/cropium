...
<head>
    ...
    <title>Register | {{ config('app.name', 'Cropium Portfolio') }}</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create an Customer Account!</h1>
                            </div>
                            <form class="user" action="{{ route('customer.register') }}" method="POST">
                                @csrf

                                <div class="form-group">
                                    <input type="text" name="name" class="form-control form-control-user" placeholder="Your Name">
                                    @error('name')
                                        <div class="form-text text-danger font-italic ml-2">{{ $message }}</div>
                                    @enderror
                                </div>
